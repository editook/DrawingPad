...
public class TestFiguresGeometrics {
  ...
  private List<ModelShape>listShapesBuilds(){
    ...
    ShapeBuild shapeBuild2= new OvalBuild(Color.BLACK,point1,point2);
  ...
  public void testCompareOrdenShapes(){
    String arrayNames[]=new String[]{"Line","Oval","Line","Rectangle","Oval"};
